...
- (void)_init
{
	...
	[self addGraphicsWithName:[NSString stringWithUTF8String:"彩色衛星雲圖（台灣）"]
                    URLString:@"http://www.cwb.gov.tw//V5/observe/satellite/Data/s3p/s3p.jpg"];	
	[self addGraphicsWithName:[NSString stringWithUTF8String:"彩色衛星雲圖（東亞）"]
                    URLString:@"http://www.cwb.gov.tw//V5/observe/satellite/Data/s1p/s1p.jpg"];
	[self addGraphicsWithName:[NSString stringWithUTF8String:"色調強化衛星雲圖（台灣）"]
                    URLString:@"http://www.cwb.gov.tw//V5/observe/satellite/Data/s3q/s3q.jpg"];
	[self addGraphicsWithName:[NSString stringWithUTF8String:"色調強化衛星雲圖（東亞）"]
                    URLString:@"http://www.cwb.gov.tw//V5/observe/satellite/Data/s1q/s1q.jpg"];
	[self addGraphicsWithName:[NSString stringWithUTF8String:"雨量累積圖"]
                    URLString:@"http://www.cwb.gov.tw//V5/observe/rainfall/Data/hk.jpg"];
	[self addGraphicsWithName:[NSString stringWithUTF8String:"雷達回波圖"]
                    URLString:@"http://www.cwb.gov.tw//V5/observe/radar/Data/r5o/r5o.gif"];	
}
